...
public class Player {
    ...
    public PlayerHousingMeta housingMeta = new PlayerHousingMeta();
    public String[] friendRequestsUuid = new String[0];
    public HashMap<PlayerPetConsumables, Integer> petConsumables = new HashMap<>();
    public PlayerVanityPackage vanityMeta = new PlayerVanityPackage();
    ...
    private PlayerPetStats petStats = new PlayerPetStats(); // Add pet stats
    ...
    private PlayerParkourCheckpoints parkourCheckpointBests = new PlayerParkourCheckpoints(); // Add checkpoints
