...
public class LevelCalculator {
    ...
    /**
     * This is the level calculator from placke/hypixel-php in java :D
     */

    static int BASE = 10000;
    static float GROWTH = 2500;

    /* Constants to generate the total amount of XP to complete a level */
    static double HALF_GROWTH = 0.5 * GROWTH;

    /* Constants to look up the level from the total amount of XP */
    static double REVERSE_PQ_PREFIX = -(BASE - 0.5 * GROWTH) / GROWTH;
    static double REVERSE_CONST = REVERSE_PQ_PREFIX * REVERSE_PQ_PREFIX;
    static float GROWTH_DIVIDES_2 = 2 / GROWTH;
     ...
     * - 79342431 XP = 249.0
     *
     * @param exp Absolute level of player (Smallest value is 1.0)
     ...
     */
    public static double getExpFromLevelToNext(float level) {
