package dev.antimoxs.hypixelapiHP.objects.guild;
...
public class Guild {
    ...
    public dev.antimoxs.hypixelapiHP.objects.guild.GuildMember[] members;
    public dev.antimoxs.hypixelapiHP.objects.guild.GuildRank[] ranks;
    ...
    public dev.antimoxs.hypixelapiHP.objects.guild.GuildMember[] getMembers()   { return this.members; }
    public dev.antimoxs.hypixelapiHP.objects.guild.GuildRank[] getRanks()       { return this.ranks; }
    ...
    public void setXPvals(){
        ...
        try {
            ...
            for (dev.antimoxs.hypixelapiHP.objects.guild.GuildMember m : this.members) {
    ...
    // Get GuildMember
    private dev.antimoxs.hypixelapiHP.objects.guild.GuildMember getMember           (String uuid) throws UnknownValueException {
        ...
        for (dev.antimoxs.hypixelapiHP.objects.guild.GuildMember member : members) {
    ...
    public dev.antimoxs.hypixelapiHP.objects.guild.GuildMember getMemberByName     (String name) {
        ...
        try {
            ...
            return new dev.antimoxs.hypixelapiHP.objects.guild.GuildMember();
        }

    }
    public dev.antimoxs.hypixelapiHP.objects.guild.GuildMember getMemberByUUID     (String uuid) {
    ...
    // Get GuildRank
    private dev.antimoxs.hypixelapiHP.objects.guild.GuildRank getGuildRank        (String name) throws UnknownValueException {
        ...
        for (dev.antimoxs.hypixelapiHP.objects.guild.GuildRank rank : this.ranks) {
    ...
    public dev.antimoxs.hypixelapiHP.objects.guild.GuildRank getGuildRankByName  (String name) {
    ...
    public ArrayList<dev.antimoxs.hypixelapiHP.objects.guild.GuildMember> getMembersSorted(GuildMemberXPDate date) {
        ...
        try {
            ...
            switch (date) {
                ...
                case TODAY:
                    return Arrays.stream(members).sorted(Comparator.comparing(dev.antimoxs.hypixelapiHP.objects.guild.GuildMember::getXP0).reversed()).collect(Collectors.toCollection(ArrayList::new));
                case YESTERDAY:
                    return Arrays.stream(members).sorted(Comparator.comparing(dev.antimoxs.hypixelapiHP.objects.guild.GuildMember::getXP1).reversed()).collect(Collectors.toCollection(ArrayList::new));
                case TWO_DAYS_AGO:
                    return Arrays.stream(members).sorted(Comparator.comparing(dev.antimoxs.hypixelapiHP.objects.guild.GuildMember::getXP2).reversed()).collect(Collectors.toCollection(ArrayList::new));
                case THREE_DAYS_AGO:
                    return Arrays.stream(members).sorted(Comparator.comparing(dev.antimoxs.hypixelapiHP.objects.guild.GuildMember::getXP3).reversed()).collect(Collectors.toCollection(ArrayList::new));
                case FOUR_DAYS_AGO:
                    return Arrays.stream(members).sorted(Comparator.comparing(dev.antimoxs.hypixelapiHP.objects.guild.GuildMember::getXP4).reversed()).collect(Collectors.toCollection(ArrayList::new));
                case FIVE_DAYS_AGO:
                    return Arrays.stream(members).sorted(Comparator.comparing(dev.antimoxs.hypixelapiHP.objects.guild.GuildMember::getXP5).reversed()).collect(Collectors.toCollection(ArrayList::new));
                case SIX_DAYS_AGO:
                    return Arrays.stream(members).sorted(Comparator.comparing(dev.antimoxs.hypixelapiHP.objects.guild.GuildMember::getXP6).reversed()).collect(Collectors.toCollection(ArrayList::new));
                case WEEK:
                    return Arrays.stream(members).sorted(Comparator.comparing(dev.antimoxs.hypixelapiHP.objects.guild.GuildMember::getXPweekTotal).reversed()).collect(Collectors.toCollection(ArrayList::new));
    ...
    public synchronized void fetchNames() {
        ...
        new Thread(fetching, () -> {
            ...
            for (dev.antimoxs.hypixelapiHP.objects.guild.GuildMember m : Arrays.copyOfRange(members,0,members.length/2)) {
